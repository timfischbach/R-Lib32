...
HTTPClient http;
WiFiClientSecure secureupdatewificlient;
Preferences preferences;

void R_Lib32::SSLSetup()
{
  if (timeAndCertificateLoaded == false)
  {
    ...
    secureupdatewificlient.setCACert(rootCACertificate);
...
void R_Lib32::updateStarted()
{
  Serial.println("[Update] HTTP update process started");
}

void R_Lib32::updateFinished()
{
  Serial.print("\n");
...
void R_Lib32::saveWIFI(String ssid, String password)
{
...
void R_Lib32::connectWIFIUser(String ssid, String password)
{
    ...
    server.on("/", []()
              {
                ...
                content = "<!DOCTYPE HTML>\r\n<html>R-Lib32 " + LIBVERSION + " by Tim Fischbach at ";
                content += ipStr;
...
String R_Lib32::getLibVersion()
{
  return LIBVERSION;
}

void R_Lib32::connectWIFIUserHandle()
{
  server.handleClient();
}

void R_Lib32::endWIFIUser()
{
  server.stop();
}

void R_Lib32::setDeviceName(String DevName)
{
  deviceName = DevName;
}

String R_Lib32::getDeviceName()
{
  return deviceName;
}

void R_Lib32::setVersion(String ver)
{
  version = ver;
}

String R_Lib32::getVersion()
{
  return version;
}

void R_Lib32::setDlLink(String DLL)
{
  dlLink = DLL;
}

String R_Lib32::getDlLink()
{
  return dlLink;
}

void R_Lib32::setBetaState(bool sbeta)
{
  betaState = sbeta;
}

bool R_Lib32::getBetaState()
{
  return betaState;
}

void R_Lib32::setDevState(bool sdev)
{
  devState = sdev;
}

bool R_Lib32::getDevState()
{
  return devState;
}

void R_Lib32::setSSLState(bool sssl)
{
  sslState = sssl;
}

bool R_Lib32::getSSLState()
{
  return sslState;
}

bool R_Lib32::varCheck()
{
  if (devState == false)
  {
...
void R_Lib32::saveOV(String oldversion)
{
  EEPROM.begin(4096);
...
String R_Lib32::performUpdate()
{
  ...
  if (oldver == ver)
  {
    ...
    else
    {
      ...
      dataTransmission("ERROR: UPDATE LOOP DETECTED! PLEASE MATCH THE VERSION IN THE SOURCECODE WITH THE FILENAME VERSION AND PUSH AN UPDATE!");
      EEPROM.begin(4096);
      EEPROM.write(4095, 1);
      EEPROM.commit();
      EEPROM.end();
  ...
  while (true)
  {
    ...
    if (sslState == true)
    {
      ret = httpUpdate.update(secureupdatewificlient, binLink);
    }
    else
    {
      ret = httpUpdate.update(updatewificlient, binLink);
    }
    switch (ret)
    {
...
void R_Lib32::setSSLRootCertificate(char certificate[])
{
  strcpy(rootCACertificate, certificate);
}

void R_Lib32::setSSLInsecureState(bool sinsecure)
{
  insecureState = sinsecure;
}

bool R_Lib32::getSSLInsecureState()
{
  return insecureState;
}

String R_Lib32::dataTransmission(String status)
{
...
void R_Lib32::setAttemptsBeforeInsecureSSL(int sattempts)
{
  attemptsBeforeInsecureSSL = sattempts;
}

int R_Lib32::getAttemptsBeforeInsecureSSL()
{
  return attemptsBeforeInsecureSSL;
}

void R_Lib32::executeAttemptsBeforeInsecureSSL()
{
...
String R_Lib32::urlEncode(String str)
{
